...
--보라
	...
	local text12 = {
		"  우와.  내  소중한  수첩을  찾아준거야?  정말  고마워!",
		"내게는  정말  소중한 물건이라  꼭  찾고  싶었어.  너는  정말  대단해!",
		"답례로  내가  제일  예쁘게  나온  사진을  줄게.  \n우린  언제까지나  친구야!"
	}
	...
	local text22 = {
		"이건내노래주머니?! 역시"..mainName.."최고야!",
		"네가아니었다면 나는 하루종일  아무것도  하지  못했을  거야.\n  정말  고마워!",
		"자.  이건  내가  처음으로  무대에  섰을  때  내  사진이야.  너에게  줄게!"
	}
	...
	local text32 = {
		"찾기  힘들었을  텐데…  정말  고마워. \n"..mainName.." 너는  정말  다정한  사람이야.",
		" 참,  이렇게  다정한  너에게  줄  선물이  있어!",
		"자,  내  사진이  담긴  솔리  액자야.  별  건  아니지만  받아줄래?"
	}
	...
	local text42 = {
		"이야,  한  번에  찾아냈잖아?!\n  넌  정말  똑똑하고  지혜로워.  역시  내  친구답다니까!",
		"고마워.  아,  나를  도와줬으니  보답을  해야지!",
		"여기,  내  사진이  담긴  위즈  액자야."
	}
	...
	local text52 = {
		"우와!(주인공), 너는 정말 대단하구나. \n나는 내가 들고 있던 다른 그림까지 날아갈까봐  무서워서  열심히  찾지  못했는데…. ",
		"정말  고마워.  혹시  답례를  해도  될까…?",
		"자,  이건  레이  액자야.  조금  마음에  들지  않아도  기쁘게  받아줬으면  좋겠어…!"
	}
