...
function scene:create( event )
	...
	t[18] = display.newText(mainName .."아, 오늘따라 우울해보이네.", display.contentWidth * 0.5, display.contentHeight * 0.93, "font/NanumSquareRoundR.ttf", 30)
	...
	t[20] = display.newText("헉··· 그러게. 어디 아픈거 아니야 ".. mainName .."아? 괜찮아?", display.contentWidth * 0.5, display.contentHeight * 0.93, "font/NanumSquareRoundR.ttf", 30)
	t[21] = display.newText("그럼 ".. mainName .." 은 평생 하얀색으로 살아야 하는거야?? 지우개처럼? 안돼!", display.contentWidth * 0.5, display.contentHeight * 0.93, "font/NanumSquareRoundR.ttf", 30)
	...
	t[23] = display.newText("걱정마 ".. mainName .."아! 우리가 도와줄게! 분명 너처럼 멋진 색을 찾을 수 있을거야.", display.contentWidth * 0.5, display.contentHeight * 0.93, "font/NanumSquareRoundR.ttf", 30)
