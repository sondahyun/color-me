...
function scene:create( event )
	...
	local background_5 = display.newImageRect("이미지/대화/우정배경/보라.pn",display.contentWidth, display.contentHeight)
...
--보라
	...
	local text21 = {
		...
		mainName  .."! 내 말 좀 들어봐. 집에 오는 길에 맛있게 생긴 레몬 쿠키가 있길래 집어 들었는데, 쿠키 안에 메모지렁이가\n있었던 거 있지!?",
		"헉, 메모지렁이?",
