...
--보라
   ...
   sceneGroup:insert(my)
	...
	--4월
	local text5 = {
		"너 그거 아니? 레몬과 바나나는 잘 어울리는 음식이야. 그리고 너와 나는 마치 레몬과 바나나 같은 콤비지."
	}
	--6월
	local text6 = {
		"여태껏 지내면서 너처럼 죽이 잘 맞는 친구는 처음이야. 앞으로도 같이 즐겁고 싶어! "
	}
	...
	--2월
	local text7 = {
		mainName  ..", 우리… 내가 생각했던 것보다 더 말이 잘 통하는 것 같아. 그런 거 있잖아, '상식이 통하는 사이'!"
	}
	--4월
	local text8 = {
	...
	--6월
	local text9 = {
		"이건 비밀인데, 내가 새로 시작한 연구가 있거든. 지혜와 상식을 갖춘 너에게만 살짝 알려줄게.\n바로… '마른하늘에 날벼락 맞는 법'이야! 참여하고 싶으면 언제든지 오라구."
	}
	...
	local text10 = {
		...
		mainName  ..", 너한테서 정말 많은 배려를 받은 것 같아서 고마워. 오늘은 답례로 내가 민트 초코 쿠키를 준비했어! 같이 먹자~"
	}
	--4월
	local text11 = {
		mainName..", 너랑 함께 놀 수 있어서 즐거웠어! 너랑 같이 있으면 마음이 편해져"
	}
	--6월
	local text12 = {
		"너는 마음이 따뜻한 연필인 것 같아. 너는 우리를 품어주는 녹색 숲처럼 마음이 넓어. 언제나 고마워!"
	}
	...
	--2월
	local text13 = {
		"너는 내가 아는 연필 중에 가장 용감해. 나도 언젠가 너처럼 용감해질 수 있겠지?"
	}
	--4월
	local text14 = {
		mainName..", 너는 참 용감하고 다정해. 무서운 책도 너와 함께라면 얼마든지 읽을 수 있겠는걸!"
	}
	--6월
	local text15 = {
		"용감한 너를 보면서 나도 용기를 얻어. 너를 본받아서 나도 더 용감한 색연필이 될래!"
	}
