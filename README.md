...
게임의 메인 캐릭터 **블랭크(Blank)** 를 비롯해 **블리, 조이, 솔리, 위즈, 레이, 모북, 종이개 등 캐릭터 8종**이 한국저작권위원회에 **미술저작물 &gt; 응용미술 &gt; 캐릭터**로 정식 등록된 오리지널 IP입니다. *(대표 등록번호 C-2023-039005)*

<img src="screenshots/캐릭터_저작권등록증.jpg" width="520" alt="블랭크(Blank) 캐릭터 저작권 등록증 (등록 8종 중 대표)"/>

> 🔒 등록 캐릭터 8종 중 대표로 블랭크 등록증 한 장만 첨부했으며, 개인정보 보호를 위해 주소와 생년월일은 가렸습니다.

## 한눈에 보기

- **장르**: 육성 시뮬레이션 / 비주얼 노벨
- **핵심 루프**: 월별 일정 관리 -> 활동 선택 -> 미니게임/이벤트 진행 -> 엔딩 분기
- **핵심 요소**: 4가지 스탯, 5개 마을 친구들, 방 꾸미기, 선물 시스템, 19가지 엔딩
...
- 숨은그림찾기 이벤트
- **19가지 멀티 엔딩**: 우정(5) + 파스텔(5) + 혼합(6) + 히든(2) + 베스트(1)
